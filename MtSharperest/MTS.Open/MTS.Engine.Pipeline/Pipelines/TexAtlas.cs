...
public class TexAtlas
{
	...
	/// will try texture sizes from 8x8 to 1024x1024
	/// </summary>
	public static PackedAtlasResults PackAtlas(int maxSizeBits, IEnumerable<RectItem> items)
	{
	...
	RETRY:
		...
		//TODO: parallelization needs more finetuning in this engine
